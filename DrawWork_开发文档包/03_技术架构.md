...
| GET | /api/boards | 列表 |
| POST | /api/boards | 创建 |
| GET | /api/boards/:id | 详情 |
| PUT | /api/boards/:id | 编辑 |
| DELETE | /api/boards/:id | 删除 |
| GET | /api/boards/:id/canvases | 画布列表 |
...
| PUT | /api/canvases/:id | 编辑 |
| DELETE | /api/canvases/:id | 删除 |

### 思维导图 / 看板 / 泳道图 (6)
| 方法 | 路径 | 说明 |
|------|------|------|
| GET/PUT | /api/canvases/:id/mindmap | 获取/保存 |
| GET/PUT | /api/canvases/:id/kanban | 获取/保存 |
| GET/PUT | /api/canvases/:id/swimlane | 获取/保存 |

### 快照 (4)
| 方法 | 路径 | 说明 |
|------|------|------|
| GET | /api/canvases/:id/snapshot | 最新快照 |
| POST | /api/canvases/:id/snapshot | 创建快照 |
| GET | /api/canvases/:id/snapshots | 快照列表 |
| GET | /api/canvases/:id/snapshots/:sid | 快照详情 |

### 分享 (5)
| 方法 | 路径 | 说明 |
|------|------|------|
| POST | /api/boards/:id/shares | 邀请用户 |
| DELETE | /api/boards/:id/shares/:uid | 移除用户 |
| POST | /api/boards/:id/tokens | 生成链接 |
| DELETE | /api/boards/:id/tokens/:tid | 撤销链接 |
| GET | /api/shares/validate | 验证链接 |
...
| PUT | /api/comments/:id/resolve | 标记解决 |
| PUT | /api/comments/:id/position | 更新坐标 |

### 投票 (3)
| 方法 | 路径 | 说明 |
|------|------|------|
| POST | /api/canvases/:id/votes | 创建 |
| POST | /api/votes/:id/records | 提交 |
| PUT | /api/votes/:id/close | 关闭 |
| GET | /api/votes/:id/results | 结果 |

### 通知 (4)
| 方法 | 路径 | 说明 |
|------|------|------|
| GET | /api/notifications | 列表 |
| PUT | /api/notifications/:id/read | 已读 |
...
|------|------|------|
| POST | /api/upload | 上传 |
| GET | /api/upload/:id | 获取 |

### 管理 (3)
| 方法 | 路径 | 说明 |
|------|------|------|
| GET | /api/admin/users | 用户列表 |
| PUT | /api/admin/users/:id | 启用/禁用 |
