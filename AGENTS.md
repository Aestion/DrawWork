# OpenClaw Project — Codex Guidelines

> **Project-specific overrides and additions to global guidelines.**
> See `~/.Codex/AGENTS.md` for base rules (Skills Priority, TDD, Debugging, etc.)
>
...
This is the **OpenClaw** project — a Codex / Codex Agent SDK related tool.
...
- **OpenClaw**: The project name — a Codex / Agent SDK related tool
- **Skill**: A reusable capability or procedure for Codex
